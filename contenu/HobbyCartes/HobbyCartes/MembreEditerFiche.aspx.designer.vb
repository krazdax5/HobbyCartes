...
Partial Public Class MembreEditerFiche

    '''<summary>
    '''Contrôle dropDownCollection.
    '''</summary>
    '''<remarks>
    ...
    '''Pour modifier, déplacez la déclaration de champ du fichier de concepteur dans le fichier code-behind.
    '''</remarks>
    Protected WithEvents dropDownEditeur As Global.System.Web.UI.WebControls.DropDownList
