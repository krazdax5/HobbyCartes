...
<asp:Content ContentPlaceHolderID="cphPageMembreContenu" runat="server">
    ...
    <div id="liste_contenu">
        <asp:PlaceHolder ID="phHockey" runat="server" Visible="false">
            <asp:Button ID="btnAjouterHockey" runat="server" Text="Ajouter la collection Hockey à mes collections" Visible="false" CssClass="btnAjouterCollection" />
        </asp:PlaceHolder>

        <asp:PlaceHolder ID="phBaseball" runat="server" Visible="false">
            <asp:Button ID="btnAjouterBaseball" runat="server" Text="Ajouter la collection Baseball à mes collections" Visible="false" CssClass="btnAjouterCollection" />
        </asp:PlaceHolder>

        <asp:PlaceHolder ID="phBasketball" runat="server" Visible="false">
            <asp:Button ID="btnAjouterBasketball" runat="server" Text="Ajouter la collection Basketball à mes collections" Visible="false" CssClass="btnAjouterCollection" />
        </asp:PlaceHolder>

        <asp:PlaceHolder ID="phFootball" runat="server" Visible="false">
            <asp:Button ID="btnAjouterFootball" runat="server" Text="Ajouter la collection Football à mes collections" Visible="false" CssClass="btnAjouterCollection" />
        </asp:PlaceHolder>
